			...
			<div class="content-wrapper">
				...
				<h1>Doctor</h1>
					...
					<div class="row"> 
						...
						<?php echo Form::model($doctor, ['method' => 'PUT', 'route' => ['doctors.update', $doctor->id]]); ?>
								...
								<table class="table datatable-responsive-column-controlled ">
									...
									<tbody>
										...
										<tr class="tr">
											...
											<td><?php echo e(Form::text('percentage', null, ['class' => 'form-control'])); ?></td>
										</tr>
						...
						<div class="col-md-4">
							<div class="well">
								...
								<div class="row">
									<div class="col-sm-6">
									<a href=<?php echo e(route('doctors.show', $doctor->id)); ?> class = "btn btn-danger btn-block">
