	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<a href="<?php echo e(route('technitions.index')); ?>"><button class="btn btn-success pull-right" style="width:100px;margin-top:22px;"><i class="fa fa-arrow-circle-left"></i></button></a>
				<h1>Technition</h1>
					...
					<div class="row"> 
						...
						<div class="col-md-4">
							<div class="well">
								...
								<div class="row">
									<div class="col-sm-6">
									<a href=<?php echo e(route('technitions.edit', $technition->id)); ?> class = "btn btn-primary btn-block">
