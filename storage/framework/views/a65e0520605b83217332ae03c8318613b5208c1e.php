			...
			<div class="content-wrapper">
				...
				<h1>User Type</h1>
					...
					<div class="row"> 
						...
						<?php echo Form::model($usertype, ['method' => 'PUT', 'route' => ['usertypes.update', $usertype->id]]); ?>
						...
						<div class="col-md-4">
							<div class="well">
								...
								<div class="row">
									<div class="col-sm-6">
									<a href=<?php echo e(route('usertypes.show', $usertype->id)); ?> class = "btn btn-danger btn-block">
