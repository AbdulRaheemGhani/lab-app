		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content">
						...
						<a href="<?php echo e(route('usertypes.create')); ?>"><button class="btn btn-success btn-lg pull-right" style="margin-top: 22px;"><i class="fa fa-plus"></i></button></a>

				<h1>User Types</h1>

			<?php if(App\Usertype::count() > 0): ?>
					...
					<div class="panel panel-flat">
						...
						<?php $__currentLoopData = $usertypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usertype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<tr class="tr">
									...
									<td><?php echo e(\Carbon\Carbon::parse($usertype->created_at)->diffForHumans()); ?></td>
									<td style="width:145px;padding:0px;"><a href="/laboratory/usertypes/<?php echo e($usertype->id); ?>">
										
											<button class="btn btn-default" id="btnView" >View Record</button>
												
										</a>

										<a href="/laboratory/usertypes/<?php echo e($usertype->id); ?>/edit">
