	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<a href="{{route('cats.index')}}"><button class="btn btn-success pull-right" style="width:100px;margin-top:22px;"><i class="fa fa-arrow-circle-left"></i></button></a>
				<h1>Test Category</h1>
						...
						<div class="col-md-4">
							<div class="well">
								...
								<div class="row">
									...
									<a href={{ route('cats.edit', $cat->id) }} class = "btn btn-primary btn-block">
